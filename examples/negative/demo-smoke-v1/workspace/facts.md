...
|---|---|---|---|---|
| F-01 | actor fact | 角色与职责相关原文段落 | examples/negative/demo-smoke-v1/source/requirement.md | 只使用当前输入，不引入外部项目产物 |
| R-01 | rule | 规则、校验或限制相关原文段落 | examples/negative/demo-smoke-v1/source/requirement.md | 用于后续业务立场判断 |
| EX-01 | exception | 失败、阻断、异常相关原文段落 | examples/negative/demo-smoke-v1/source/requirement.md | 用于体验层异常态设计 |
