...
- examples/negative/demo-smoke-v1/source/requirement.md
- examples/negative/demo-smoke-v1/source/background.md
...
- examples/negative/demo-smoke-v1/workspace/gap_list.md
- examples/negative/demo-smoke-v1/workspace/check_report.md
- examples/negative/demo-smoke-v1/workspace/check_status.json
...
- 执行中结果: examples/negative/demo-smoke-v1/workspace/
- 归档结果: examples/negative/demo-smoke-v1/exports/final/
