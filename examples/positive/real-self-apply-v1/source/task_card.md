...
- examples/positive/real-self-apply-v1/source/requirement.md
- examples/positive/real-self-apply-v1/source/background.md
...
- 执行中结果: examples/positive/real-self-apply-v1/workspace/
- 归档结果: examples/positive/real-self-apply-v1/exports/final/
