...
When a host project has `tracking_spec.md`, use it as the highest-priority local tracking specification. Otherwise use the host's tracking method document, such as `knowledge/raw/业务/埋点统一方法.md`.
