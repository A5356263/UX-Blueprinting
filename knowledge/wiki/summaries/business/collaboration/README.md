...
- page_id: PG-SUMMARY-BUSINESS-BUSINESS-COLLABORATION-README
- page_type: summary
- source_path: knowledge/raw/business/collaboration/README.md
...
- source_refs: [knowledge/raw/business/collaboration/README.md]
- related_summaries:
...
协同办公域顶层索引，对应帮助中心"协同办公"一级模块。OA审批保留在approval_management域。
...
- smart_reports（智数报表）、collaboration_tools（协同工具7个）

## 4. 可直接使用的稳定结论

- 协同办公域按帮助中心模块结构组织
- OA审批不在本域，保留在approval_management
## 7. 邻近阅读
- knowledge/wiki/summaries/business/collaboration/00_domain_overview.md
- knowledge/wiki/summaries/business/collaboration/smart_reports/README.md
- knowledge/wiki/summaries/business/collaboration/collaboration_tools/README.md
> summary_path: knowledge/wiki/summaries/business/collaboration/README.md
