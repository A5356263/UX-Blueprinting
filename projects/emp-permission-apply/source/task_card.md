...
- Task ID: emp-permission-apply
- Task Name: 员工自助申请权限
- Domain: 权限管理

## Required Inputs

- projects/emp-permission-apply/source/requirement.md
- projects/emp-permission-apply/source/background.md

## Required Outputs

- projects/emp-permission-apply/workspace/facts.md
- projects/emp-permission-apply/workspace/business_blueprint.md
- projects/emp-permission-apply/workspace/experience_blueprint.md
- projects/emp-permission-apply/workspace/gap_list.md
- projects/emp-permission-apply/workspace/check_report.md
- projects/emp-permission-apply/workspace/check_status.json
