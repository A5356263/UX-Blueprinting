...
- projects/quick-permission-search/source/requirement.md
- projects/quick-permission-search/source/background.md

## Required Outputs

- projects/quick-permission-search/workspace/facts.md
- projects/quick-permission-search/workspace/business_blueprint.md
- projects/quick-permission-search/workspace/experience_blueprint.md
- projects/quick-permission-search/workspace/gap_list.md
- projects/quick-permission-search/workspace/check_report.md
- projects/quick-permission-search/workspace/check_status.json

## Read Order

1. 先读本文件
2. 再读 `Required Inputs`
3. 生成 facts.md（详见 `specs/08_fact_extraction_contract.md`）→ 运行 `python -m packages gate-facts quick-permission-search`，通过才能进入下一步
4. 生成 business_blueprint.md（详见 `specs/09_business_blueprint_contract.md`）→ 运行 `python -m packages gate-business quick-permission-search`，通过才能进入下一步
5. 生成 experience_blueprint.md（详见 `specs/10_experience_blueprint_contract.md`）→ 运行 `python -m packages gate-experience quick-permission-search`，通过才能进入下一步
6. 运行 `python -m packages validate quick-permission-search` 和 `python -m packages coverage quick-permission-search`
7. 运行 `python -m packages archive quick-permission-search`（产物镜像到 exports/）
8. 运行 `python -m packages preview quick-permission-search --no-serve`（生成静态预览 HTML 到 runtime/preview/）
...
- 执行中结果: projects/quick-permission-search/workspace/
- 归档结果: projects/quick-permission-search/exports/final/
