...
- Task ID: uxb-qc-004-sub-admin-copy
- Task Name: 子管理员支持复制
- Domain: 权限管理
...
- projects/uxb-qc-004-sub-admin-copy/workspace/business_blueprint.md
- projects/uxb-qc-004-sub-admin-copy/workspace/experience_blueprint.md
- projects/uxb-qc-004-sub-admin-copy/workspace/gap_list.md
- projects/uxb-qc-004-sub-admin-copy/workspace/check_report.md
- projects/uxb-qc-004-sub-admin-copy/workspace/check_status.json
...
- 执行中结果: projects/uxb-qc-004-sub-admin-copy/workspace/
- 归档结果: projects/uxb-qc-004-sub-admin-copy/exports/final/
...
- UXB 应在执行前写好 `projects/uxb-qc-004-sub-admin-copy/runtime/uxb_route_decision.json`
