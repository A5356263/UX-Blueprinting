...
- Task ID: uxb-qc-002-permission-query
- Task Name: 权限查询
- Domain: 权限管理
...
- projects/uxb-qc-002-permission-query/workspace/gap_list.md
- projects/uxb-qc-002-permission-query/workspace/check_report.md
- projects/uxb-qc-002-permission-query/workspace/check_status.json
...
- 执行中结果: projects/uxb-qc-002-permission-query/workspace/
- 归档结果: projects/uxb-qc-002-permission-query/exports/final/
...
- UXB 应在执行前写好 `projects/uxb-qc-002-permission-query/runtime/uxb_route_decision.json`
