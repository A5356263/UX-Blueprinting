...
- 基于《权限需求文档》，从零建立“员工自助申请与查询权限能力”的结构化事实、业务判断与体验方案
- 本次输出用于产品方案评审与体验设计评审，目标是形成可追踪、可校验的正式产物

## Task Scenario

- 本次任务场景：围绕员工自助申请权限模式、我的权限、申请权限三块需求进行全链路建模
- 任务类型：新建任务（Task ID=005），不沿用历史任务定义、成功标准与正式产物
- 执行范围：覆盖 facts / business / experience 全链路，并完成 gate、validate、coverage、archive

## Required Inputs

- projects/005/source/requirement.md
- projects/005/source/background.md

## Required Outputs

- projects/005/workspace/facts.md
- projects/005/workspace/business_blueprint.md
- projects/005/workspace/experience_blueprint.md
- projects/005/workspace/gap_list.md
- projects/005/workspace/check_report.md
- projects/005/workspace/check_status.json
...
- 执行中结果: projects/005/workspace/
- 归档结果: projects/005/exports/final/
