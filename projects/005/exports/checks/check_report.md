...
- projects/005/workspace/facts.md: present
- projects/005/workspace/business_blueprint.md: present
- projects/005/workspace/experience_blueprint.md: present
- projects/005/workspace/gap_list.md: present
- projects/005/workspace/check_report.md: present
- projects/005/workspace/check_status.json: present
...
- experience_blueprint.md 已承接 4 条业务判断
...
- 机器可读状态文件：`projects/005/workspace/check_status.json`
