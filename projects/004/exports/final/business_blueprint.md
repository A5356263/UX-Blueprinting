...
| --- | --- | --- | --- | --- | --- | --- |
| J-01 | 问题与意图是否足以支撑当前改造 | 成立 | F-A01, F-A02, F-A03, F-A04 | BL-01, BL-02, BL-03 | OPT-01, OPT-02 | GAP-01: 约束说明：信息不足处在正式产物中以 `[GAP]` 标记，不臆造事实。 |
| J-02 | 当前输入与命中知识是否形成稳定基线 | 较稳定 | F-A01, F-A02, F-A03, F-A04 | BL-01, BL-02, BL-03 | OPT-01, OPT-02 | GAP-01: 约束说明：信息不足处在正式产物中以 `[GAP]` 标记，不臆造事实。 |
...
| J-05 | 信息充分性是否足够下最终立场 | 可下保守立场 | F-A01, F-A02, F-A03, F-A04 | BL-01, BL-02, BL-03 | OPT-01, OPT-02 | GAP-01: 约束说明：信息不足处在正式产物中以 `[GAP]` 标记，不臆造事实。 |
...
| --- | --- | --- | --- | --- | --- |
| RSK-01 | 信息缺口会让业务结论失稳 | GAP-01: 约束说明：信息不足处在正式产物中以 `[GAP]` 标记，不臆造事实。 | 如果信息还不够就强行定方案，后续判断容易失真并带来误判。 | 中 | 保留缺口并给出谨慎建议，先说明适用范围、限制条件和后续补齐项。 |
