...
- projects/004/workspace/facts.md: present
- projects/004/workspace/business_blueprint.md: present
- projects/004/workspace/experience_blueprint.md: present
- projects/004/workspace/gap_list.md: present
- projects/004/workspace/check_report.md: present
- projects/004/workspace/check_status.json: present
...
- experience_blueprint.md 核心区存在重复动词表达
...
- 机器可读状态文件：`projects/004/workspace/check_status.json`
