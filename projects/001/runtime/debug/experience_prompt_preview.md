...
> 权威输入：`projects/001/workspace/facts.md`、`projects/001/workspace/business_blueprint.md`、`specs/10_experience_blueprint_contract.md`、`templates/experience_blueprint.template.md`
