...
> 本文件是 `projects/input-validation-standard-self-permission-low/workspace/check_status.json` 的人读说明版。
...
- projects/input-validation-standard-self-permission-low/workspace/facts.md: present
- projects/input-validation-standard-self-permission-low/workspace/business_blueprint.md: present
- projects/input-validation-standard-self-permission-low/workspace/experience_blueprint.md: present
- projects/input-validation-standard-self-permission-low/workspace/gap_list.md: present
- projects/input-validation-standard-self-permission-low/workspace/check_report.md: present
- projects/input-validation-standard-self-permission-low/workspace/check_status.json: present
...
- 机器可读状态文件：`projects/input-validation-standard-self-permission-low/workspace/check_status.json`
