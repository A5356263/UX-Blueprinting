...
> 本文件是 `projects/input-validation-full-permission-query-multidimension/workspace/check_status.json` 的人读说明版。
...
- projects/input-validation-full-permission-query-multidimension/workspace/facts.md: present
- projects/input-validation-full-permission-query-multidimension/workspace/business_blueprint.md: present
- projects/input-validation-full-permission-query-multidimension/workspace/experience_blueprint.md: present
- projects/input-validation-full-permission-query-multidimension/workspace/gap_list.md: present
- projects/input-validation-full-permission-query-multidimension/workspace/check_report.md: present
- projects/input-validation-full-permission-query-multidimension/workspace/check_status.json: present
...
- 机器可读状态文件：`projects/input-validation-full-permission-query-multidimension/workspace/check_status.json`
