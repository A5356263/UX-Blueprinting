...
- project_id: input-validation-full-self-permission-high
- stage: experience
...
- projects/input-validation-full-self-permission-high/runtime/provenance.json
- projects/input-validation-full-self-permission-high/runtime/gates/business_gate_status.json
