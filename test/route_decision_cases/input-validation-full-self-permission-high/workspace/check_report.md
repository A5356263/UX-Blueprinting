...
> 本文件是 `projects/input-validation-full-self-permission-high/workspace/check_status.json` 的人读说明版。
...
- projects/input-validation-full-self-permission-high/workspace/facts.md: present
- projects/input-validation-full-self-permission-high/workspace/business_blueprint.md: present
- projects/input-validation-full-self-permission-high/workspace/experience_blueprint.md: present
- projects/input-validation-full-self-permission-high/workspace/gap_list.md: present
- projects/input-validation-full-self-permission-high/workspace/check_report.md: present
- projects/input-validation-full-self-permission-high/workspace/check_status.json: present
...
- 机器可读状态文件：`projects/input-validation-full-self-permission-high/workspace/check_status.json`
