...
> 本文件是 `projects/input-validation-full-subadmin-copy-approval/workspace/check_status.json` 的人读说明版。
...
- projects/input-validation-full-subadmin-copy-approval/workspace/facts.md: present
- projects/input-validation-full-subadmin-copy-approval/workspace/business_blueprint.md: present
- projects/input-validation-full-subadmin-copy-approval/workspace/experience_blueprint.md: present
- projects/input-validation-full-subadmin-copy-approval/workspace/gap_list.md: present
- projects/input-validation-full-subadmin-copy-approval/workspace/check_report.md: present
- projects/input-validation-full-subadmin-copy-approval/workspace/check_status.json: present
...
- 机器可读状态文件：`projects/input-validation-full-subadmin-copy-approval/workspace/check_status.json`
