...
class ValidateModeRoutingTests(unittest.TestCase):
    ...
    def test_validate_dispatches_fast_mode_to_lite(
        self,
        _mode,
        validate_lite,
        validate_full,
    ...
    @patch("packages.validate.core.run_coverage_lite", return_value=44)
    @patch("packages.validate.core._final_check_execution_mode", return_value="standard")
    def test_coverage_dispatches_standard_mode_to_lite(
        self,
        _mode,
        coverage_lite,
        coverage_full,
    ...
    @patch("packages.validate.core.run_coverage_lite", return_value=44)
    @patch("packages.validate.core._final_check_execution_mode", return_value="full")
    def test_coverage_dispatches_full_mode_to_full(
        self,
        _mode,
        coverage_lite,
        coverage_full,
        ...
        coverage_full.assert_called_once_with("demo")
        coverage_lite.assert_not_called()
